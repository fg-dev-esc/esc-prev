    ...
    <section class="logos-section-unified">
      <div class="container">
        ...
        <div class="logos-grid-unified">
          <div class="logo-item">
            <img src="${basePath}assets/img/logos/abbott.png" alt="Abbott">
          </div>
          <div class="logo-item">
            <img src="${basePath}assets/img/logos/actuarios.png" alt="Actuarios">
          </div>
          <div class="logo-item">
            <img src="${basePath}assets/img/logos/aig.png" alt="AIG">
          </div>
          <div class="logo-item">
            <img src="${basePath}assets/img/logos/asofarma.png" alt="Asofarma">
          </div>
          <div class="logo-item">
            <img src="${basePath}assets/img/logos/avis.png" alt="Avis">
          </div>
          <div class="logo-item">
            <img src="${basePath}assets/img/logos/bancoppel.png" alt="Bancoppel">
          </div>
          <div class="logo-item">
            <img src="${basePath}assets/img/logos/banorte.png" alt="Banorte">
          </div>
          <div class="logo-item">
          ...
          <div class="logo-item">
            <img src="${basePath}assets/img/logos/cadi.png" alt="Cadi">
          </div>
          <div class="logo-item">
            <img src="${basePath}assets/img/logos/chedraui.png" alt="Chedraui">
          </div>
          <div class="logo-item">
            <img src="${basePath}assets/img/logos/contigo.png" alt="Contigo">
          </div>
          <div class="logo-item">
            <img src="${basePath}assets/img/logos/coppel.png" alt="Coppel">
          </div>
          <div class="logo-item">
            <img src="${basePath}assets/img/logos/crediplata.png" alt="Crediplata">
          </div>
          <div class="logo-item">
            <img src="${basePath}assets/img/logos/edomex.png" alt="Edomex">
          </div>
          <div class="logo-item">
            <img src="${basePath}assets/img/logos/general de seguros.png" alt="General de Seguros">
          </div>
          <div class="logo-item">
            <img src="${basePath}assets/img/logos/gnp.png" alt="GNP">
          </div>
          <div class="logo-item">
            <img src="${basePath}assets/img/logos/inter.png" alt="Inter">
          </div>
          <div class="logo-item">
            <img src="${basePath}assets/img/logos/lilly.png" alt="Lilly">
          </div>
          <div class="logo-item">
            <img src="${basePath}assets/img/logos/liverpool.png" alt="Liverpool">
          </div>
          <div class="logo-item">
            <img src="${basePath}assets/img/logos/merck.png" alt="Merck">
          </div>
          <div class="logo-item">
            <img src="${basePath}assets/img/logos/multiasistencia.png" alt="Multiasistencia">
          </div>
          <div class="logo-item">
          ...
          <div class="logo-item">
            <img src="${basePath}assets/img/logos/sura.png" alt="Sura">
          </div>
          <div class="logo-item">
            <img src="${basePath}assets/img/logos/vw.png" alt="VW">
          </div>
          <div class="logo-item">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="footer-brand" style="padding-top: 0.5rem;">
              <a href="https://www.escotel.com.mx" class="d-inline-block mb-3">
                <img src="${basePath}assets/img/logo-escotel.png" class="footer-logo" alt="ESCOTEL Logo" style="height: 40px; width: auto;">
              </a>
